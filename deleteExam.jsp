...
<style>
body {background: linear-gradient(to right, #667eea, #764ba2); font-family: 'Segoe UI', sans-serif;}
...
<li class="nav-item"><a class="nav-link active" href="deleteExam.jsp"><i class="fas fa-trash-alt"></i> Delete Exam</a></li>
...
<h2 class="mb-4 text-danger text-center"><i class="fas fa-trash-alt"></i> Delete Exam</h2>
...
<button type="submit" class="btn btn-danger btn-submit"><i class="fas fa-trash"></i> Delete Exam</button>
</div>
</form>
</div>
</div>
