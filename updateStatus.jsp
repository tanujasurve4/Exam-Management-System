...
<head>
<meta charset="UTF-8">
<title>Update Exam Status</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
<style>
body {background: linear-gradient(to right, #ff758c, #ff7eb3); font-family: 'Segoe UI', sans-serif;}
...
<li class="nav-item"><a class="nav-link active" href="updateStatus.jsp"><i class="fas fa-sync-alt"></i> Update Status</a></li>
...
<h2 class="mb-4 text-danger text-center"><i class="fas fa-sync-alt"></i> Update Exam Status</h2>

<!-- ✅ Corrected form action -->
<form action="UpdateExamStatus" method="post">
<div class="mb-3">
<label>Exam ID</label>
...
<button type="submit" class="btn btn-danger btn-submit"><i class="fas fa-save"></i> Update Status</button>
</div>
</form>
</div>
</div>
